...
@Controller
@RequestMapping(path="/talidong/student") // Updated URI
public class MainController {
    ...
    public ResponseEntity createStudent(@RequestBody Student student) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/talidong/student/" + savedStudent.getId())).body(savedStudent);
    }
